...
export type Database = {
  public: {
    Tables: {
      ...
      properties: {
        Row: {
          address: string | null
          created_at: string
          creation_method: Database["public"]["Enums"]["property_creation_method"]
          id: string
          location: unknown | null
          metadata: Json | null
          official_boundary: unknown | null
      ...
      survey_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "survey_assignments_property_id_fkey"
            columns: ["property_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "survey_assignments_surveyor_user_id_fkey"
            columns: ["surveyor_user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
      ...
      survey_responses: {
        Row: {
          ...
          id: string
          location_submitted: unknown | null
          metadata: Json | null
          responses: Json
          submitted_at: string
    ...
    Enums: {
      ...
      property_creation_method:
        | "client_provided"
        | "surveyor_created"
        | "admin_placeholder"
        | "unknown"
      property_type: "house" | "apartment_building" | "multi_floor_house"
      user_role: "super_admin" | "admin" | "analyst" | "surveyor"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
