...
export const columns: ColumnDef<Organization>[] = [
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <Link
          href={`/organizations/${encodeURIComponent(name)}`}
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuGroup>
              ...
              <DropdownMenuItem asChild>
                <Link
                  href={`/organizations/${encodeURIComponent(organization.name)}/edit`}
                >
              ...
              <DropdownMenuItem asChild>
                <Link
                  href={`/organizations/${encodeURIComponent(organization.name)}/users`}
                >
