  ...
  useEffect(() => {
    if (isOpen && sectionId && questionId) {
      ...
      if (question) {
        ...
        setHasOtherOption(question.hasOtherOption || false);
              ...
              {['radio', 'checkbox'].includes(questionType) && (
                <div className="flex items-center space-x-2 mt-4">
                  <Switch 
                    ...
                    onCheckedChange={setHasOtherOption}
                  />
                  <div>
                    <Label htmlFor="has-other-option">Incluir opción "Otro"</Label>
                    <p className="text-xs text-muted-foreground">
                      Permite que los usuarios ingresen un valor personalizado además de las opciones predefinidas
                    </p>
                  </div>
                </div>
              )}
